...
module.exports = class Client {
  ...
  constructor(clientOptions = {}) {
    ...
    let agent = undefined;
    const proxyUrl = clientOptions.proxy || process.env.TV_API_PROXY;
    if (proxyUrl) {
      ...
      if (global.TW_DEBUG) console.log('Using proxy agent for TradingView WS:', proxyUrl);
    }
